    ...
    <div id="page-wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="panel panel-green">
                    ...
                    <div class="panel-footer">
                        <div class="row">
                            ...
                            <button type="button" data-toggle="modal" data-target="#delUsers" class="btn btn-danger">Delete</button>
                ...
                <!-- PANEL END -->
                <!-- MODAL -->
                <div class="modal fade" id="delUsers" role="dialog">
                    <!-- MODAL CONTENT-->
                    <div class="modal-dialog">
                        <div class="modal-content ">
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-success" onclick="deleteUsers()">Yes</button>
